...
Notice that we've also omitted the parentheses around the parameter since it's the only one. If you have more than one parameter, or if you have no parameters at all, you would still need the parentheses.
...
<Callout type="info" emoji="️🆘">
  I understand that concepts like arrow functions and higher order function can
  seem complex initially, especially when you're starting your journey with
