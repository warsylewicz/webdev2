...
The guide is designed to help developers streamline their coding process, ensure their code is safely versioned with Git, and keep their work synced on GitHub.
...
<Callout type="info" emoji="ℹ️">
  It is highly have to have a quick look at your code on GitHub to make sure
  everything looks good. You can do this by going to your repository on GitHub
  and clicking on the "Code" tab. You can also view your commit history by
  clicking on the "Commits" tab.
</Callout>

<Callout emoji="👍">
  Always remember to commit frequently and write clear, descriptive commit
  messages. Your code backup is only as good as your last commit!
</Callout>
...
Remember, this is a cycle: the next time you come back to code, you'll start at Part 1 again. Happy coding!
