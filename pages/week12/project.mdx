...
Welcome to the first sprint of Phase 2 in your project! This week, you'll begin to see your planning from Phase 1 materialize into a working application. Here are the specific requirements for this sprint.

## Commit Requirements

Every member of your group (or you, if working individually) should make at least one commit to the project repository during this sprint. This is a requirement to receive participation marks for this phase. Remember, each commit should reflect a meaningful change or addition to your project; try to avoid "empty" commits that don't contribute to the progress of the project.
