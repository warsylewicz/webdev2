...
Complete [Week 4 Assignment](/week4/assignment) and [Week 5 Assignment](/week5/assignment). If you did not complete the Week 4 and Week 5 assignments, you can use another student's [solution](/github-accounts) by copying the files from their GitHub repository into your own.
...
Let's first create a new workspace for this assignment and populating it with the files from previous assignments to use as a starting point.

- Create a new folder called `week6` inside your `app` folder.
- Copy `item-list.js`, `item.js`, `items.json`, and `page.js` from /week5 to /week6.
