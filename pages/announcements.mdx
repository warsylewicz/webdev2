...
If your Web Development 1 course from the first semester was a paddling pool, this semester, we're swimming in the deep end! This week we'll be diving into React and getting our hands dirty with some coding. Below you'll find the content for this week and details about your assignment.
...
- **Next.js Skills:** We'll understand the structure of a Next.js project, focusing on the /app and package.json files.
...
You can find more detailed information about this week's content in the course materials. Please complete the two-hour online class reading and activities before our in-person class.
