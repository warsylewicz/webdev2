...
You will be responsible for the entire development process, from idea generation to deployment. You will be using the agile development methodology, which means that you will be working in three short sprints of 1 week each, and you will be presenting your progress at the end of each sprint. You will be using GitHub to manage the code for the project and Vercel for deployment.

The project consists of three phases:

| Phase   | Description                                                                                             | Due Date       |
| ------- | ------------------------------------------------------------------------------------------------------- | -------------- |
| Phase 1 | [Project Selection, Planning, and Design](/week9/project#phase-1-project-selection-planning-and-design) | End of Week 9  |
| Phase 2 | Project Development and Implementation                                                                  |                |
| -       | [Sprint 1](/week12/project)                                                                             | End of Week 12 |
| -       | [Sprint 2](/week13/project)                                                                             | End of Week 13 |
| -       | [Sprint 3](/week14#phase-2---sprint-3)                                                                  | End of Week 14 |
| Phase 3 | Project Deployment                                                                                      |                |
| -       | [Self-Reflection](/week14#project-phase-3-self-reflection)                                              | End of Week 14 |
| -       | [Showcase](/week15)                                                                                     | Week 15        |
...
**Starter Level**: At the very least, your web app should be interactive, incorporating the content from Weeks 1 to 4.

**Intermediate Level**: Ideally, your web application should include technologies covered up to Week 7. This means your application should be able to fetch data from an external API and display it.

**Advanced Level**: If you're up for a more comprehensive challenge, consider implementing authentication, a database, and/or the use of any additional libraries (installed using `npm install`) into your web application. This incorporates content up to Week 10. Libraries can be used to add extra functionality, handle complex tasks, or improve your development process.

**Expert Level**: For those aiming for an in-depth understanding, aim to build a full-stack application with a RESTful API backend. This includes all content up to Week 11.
