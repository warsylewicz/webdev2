...
Send your GitHub username to your instructor via <a href={process.env.NEXT_PUBLIC_INSTRUCTOR_TEAMS_CHAT} target="_blank">MS Teams Chat</a>. If you have a preferred name that you would like to be called, please include that as well.
