...
- If you pass an empty array (`[]`), the `useEffect` hook will run the effect only once after the initial render, similar to the '[mounted](/week-6/state#component-lifecycle)' phase in the component lifecycle.
