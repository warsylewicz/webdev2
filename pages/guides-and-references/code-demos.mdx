# Guide: Accessing the Code Demos
...
Choose the tab "URL" and enter the following repository URL: https://github.com/warsylewicz/webdev2-demos
...
As the course progresses, I will add more content to the course demo repository. You can pull the latest changes from the course demo repository to get the latest content. I recommend that you do this before each class.

To do this, open the course demo repository in GitHub Desktop and click "Fetch origin" in the top right corner. Then click "Pull origin" to pull the latest changes.
