...
Enter the following command, where [app-name] is the name of your app. Do not use any spaces in the name:
`npx create-next-app@latest [app-name]`

The create-next-app application will scaffold a new Next.js project. For this course, here is how you should answer the questions:
